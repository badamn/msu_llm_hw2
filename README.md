...
Пайплайн: RSS → LLM (OpenAI) → TTS (gTTS, при необходимости) → аватар HeyGen → фон/титры → экспорт .mp4. Запуск одной командой `run_pipeline.py`, все артефакты сохраняются в `outputs/`.
